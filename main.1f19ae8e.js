...
},{}],"bubble.frag":[function(require,module,exports) {
...
var _bubble = _interopRequireDefault(require("./bubble.frag"));
...
function create_fragment(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      (0, _internal.add_location)(div0, file, 137, 2, 4046);
      (0, _internal.attr_dev)(div1, "class", "title svelte-lg7b2e");
      (0, _internal.add_location)(div1, file, 138, 2, 4073);
      (0, _internal.attr_dev)(div2, "class", "header svelte-lg7b2e");
      (0, _internal.add_location)(div2, file, 136, 1, 4023);
      (0, _internal.attr_dev)(button, "class", "svelte-lg7b2e");
      (0, _internal.add_location)(button, file, 145, 1, 4271);
      (0, _internal.attr_dev)(div3, "class", "control-panel svelte-lg7b2e");
      (0, _internal.add_location)(div3, file, 135, 0, 3994);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
...
function instance($$self, $$props, $$invalidate) {
  ...
  shaderFrag["Bubble"] = _bubble.default;
...
var _default = App;
exports.default = _default;
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","./Control.svelte":"Control.svelte","./Shader.svelte":"Shader.svelte","./yomqo.frag":"yomqo.frag","./bubble.frag":"bubble.frag","./openeye.frag":"openeye.frag","./test.frag":"test.frag","./SuisseIntl-Book-WebTrial.woff":[["SuisseIntl-Book-WebTrial.21b2577c.woff","SuisseIntl-Book-WebTrial.woff"],"SuisseIntl-Book-WebTrial.woff"],"./logo.png":[["logo.de01bb0e.png","logo.png"],"logo.png"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"main.js":[function(require,module,exports) {
"use strict";
